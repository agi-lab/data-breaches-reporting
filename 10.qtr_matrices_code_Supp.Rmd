---
title: "Construct matrices containing upper triangles (actual data) and lower triangles (filled with zeros)"
output:
  html_document:
    toc: yes
    toc_depth: '4'
...
## Construct and store quarterly matrices
...
hi=1:40
colnames(quarterly)<-c(hi,"Sum")
rownames(quarterly)<-c(hi,"Sum")

kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (California, 2012Q1-2021Q4)") %>%
...
origin.period <- sort(rep(1:40, 40))
dev.period <- rep(1:40, 40)
...
hi1=9:38
hi2=1:30
colnames(quarterly)<-c(hi2,"Sum")
rownames(quarterly)<-c(hi1,"Sum")

kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Indiana, 2014Q1 - 2021Q2)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
origin.period <- sort(rep(1:30, 30))
origin.period <- origin.period+8
dev.period <- rep(1:30, 30)
c <- origin.period+dev.period-1
...
hi1=1:25
hi2=16:40
colnames(quarterly)<-c(hi1,"Sum")
rownames(quarterly)<-c(hi2,"Sum")

kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Montana, 2015Q4 - 2021Q4)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
origin.period <- sort(rep(1:25, 25))
origin.period <- origin.period+15
dev.period <- rep(1:25, 25)
c <- origin.period+dev.period-1
...
kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Maine, 2013Q1 - 2020Q2)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (North Dakota, 2019Q1 - 2021Q4)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
origin.period <- sort(rep(1:12, 12))
origin.period <- origin.period+28
dev.period <- rep(1:12, 12)
c <- origin.period+dev.period-1
...
kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Washington, 2015Q4 - 2021Q4)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Delaware, 2018Q2-2021Q4)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
origin.period <- sort(rep(1:15, 15))
origin.period <- origin.period+25
dev.period <- rep(1:15, 15)
c <- origin.period+dev.period-1
...
kbl(quarterly, booktabs = T,caption = "Quarterly Frequency Triangle (Oregon, 2016Q1 - 2021Q4)") %>%
kable_styling(latex_options = "scale_down",position = "center")
```
...
origin.period <- sort(rep(1:24, 24))
origin.period <- origin.period+16
dev.period <- rep(1:24, 24)
c <- origin.period+dev.period-1
...
write_csv(functional_form_data,"~/Dropbox/R_Studio/Cyber Paper/qtr_matrices_data.csv")
```
